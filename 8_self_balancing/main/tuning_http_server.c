...
static pid_const_t pid_constants = {.kp = 15.1, .ki = 0.075, .kd = 9.0, .setpoint = 0.0, .offset = 2.51};
...
static esp_err_t tuning_pid_post_handler(httpd_req_t *req)
{
    ...
    pid_constants.offset = (float)cJSON_GetObjectItem(root, "offset")->valuedouble;
